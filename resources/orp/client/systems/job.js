...
import { drawText3d } from '/client/utility/text.js';
import { View } from '../utility/view.js';

alt.log('Loaded: client->systems->job.js');
...
function setupObjective(value) {
    ...
    alt.log(`job.js ${objectiveInfo}`);
    alt.log(`job.js ObjChecking ${objectiveChecking}`);
    pause = false;
}
